...
CREATE INDEX IF NOT EXISTS idx_messages_user_id_agent_id ON messages(user_id, agent_id);
CREATE INDEX IF NOT EXISTS idx_messages_created_at ON messages(created_at);

-- Indexes for user_personas table
CREATE INDEX IF NOT EXISTS idx_user_personas_user_id_agent_id ON user_personas(user_id, agent_id);
CREATE INDEX IF NOT EXISTS idx_user_personas_created_at ON user_personas(created_at);
CREATE INDEX IF NOT EXISTS idx_user_personas_version ON user_personas(version);
