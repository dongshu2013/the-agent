...
async def _chat_with_mastra(
    ...
    """ connect to local Mastra/Camel service"""
    ...
    try:
        ...
        logger.error(f"connect to Mastra service error: {str(e)}", exc_info=True)
        raise ValueError(f"connect to Mastra service error: {str(e)}") 