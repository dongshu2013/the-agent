...
export class CreateConversationV2 extends OpenAPIRoute {
  schema = {
    responses: {
      '200': {
...
export class DeleteConversationV2 extends OpenAPIRoute {
  schema = {
    request: {
      query: z.object({
...
export class ListConversationsV2 extends OpenAPIRoute {
  schema = {
    responses: {
      '200': {
