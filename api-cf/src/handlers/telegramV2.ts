...
// ===== GET TELEGRAM DIALOGS V2 =====

export class GetTelegramDialogsV2 extends OpenAPIRoute {
  schema = {
    request: {
      query: z.object({
        limit: z
...
export class GetTelegramMessagesV2 extends OpenAPIRoute {
  schema = {
    request: {
      query: z.object({
        chat_id: z.string(),
...
export class SearchTelegramMessagesV2 extends OpenAPIRoute {
  schema = {
    request: {
      query: z.object({
        query: z.string(),
...
export async function handleGetTelegramDialogsV2Options(_c: Context) {
...
export async function handleGetTelegramMessagesV2Options(_c: Context) {
  return new Response(null, {
    status: 204,
    headers: corsHeaders,
  });
...
export async function handleSearchTelegramMessagesV2Options(_c: Context) {
  return new Response(null, {
    status: 204,
    headers: corsHeaders,
  });
